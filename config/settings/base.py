...
MIGRATION_MODULES = {"sites": "panasystem.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    "panasystem.users.middlewares.BlacklistAccessTokenMiddleware"
]
...
ADMINS = [("""Lucas Leone""", "lucas-leone@panaderialeone.com")]
...
SIMPLE_JWT = {
    ...
    "SIGNING_KEY": env(
        "DJANGO_SECRET_KEY",
        default="xR5ihe8344hanCoxFk8qLhWsJgr5Nss26nseIxGvxeJ2Adx7Efdf0PZgCsPcN7SN",
    ),
    "VERIFYING_KEY": None,
    "AUDIENCE": None,
    "ISSUER": None,
